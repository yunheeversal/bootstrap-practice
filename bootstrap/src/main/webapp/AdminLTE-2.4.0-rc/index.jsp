...
%>
<%-- <%@ page import="chap08.member.MemberInfo" %> <%MemberInfo member = new MemberInfo(); %>
 --%>
								...
								<li>
									...
									<ul class="menu">
										<li>
											<!-- Task item --> <a href="#">
												<h3>
													Design some buttons <small class="
">20%</small>
												</h3>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								alt="User Image"> <span class="hidden-xs"> <%-- <%= request.getParameter("email") %> --%>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<script type="text/javascript"
					src="pages/examples/js/jquery-1.10.2.min.js"></script>
				<script type="text/javascript"
				...
				<p id="pop_wrap">
					<img src="pages/examples/images/popup.jpg"
						alt="ê²ìì´ ìëë í¤ìëë ë°ë¡ ìë¤!"
						usemap="#pop" />
					<map name="pop" id="pop">
						<area shape="rect" coords="255,332,290,345" href="#"
							alt="ì°½ë«ê¸°" />
