...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			 ...
			 <form action="${pageContext.request.contextPath}/login.do"
				...
				<div class="form-group has-feedback">
					...
					<input type="email" class="form-control" name="email"
						value="${param.email}" placeholder=${email} > <!-- <span
						class="glyphicon glyphicon-envelope form-control-feedback"></span> -->
				 <span style="color: red"><c:if test="${errors.id}">이메일을 입력하세요.</c:if></span>
				</div>
				<div class="form-group has-feedback">
        	...
        	<c:if test="${errors.idOrPwNotMatch}">암호와 확인이 일치하지 않습니다.</c:if>
		</span>
				...
				<div class="row">
					<div class="col-xs-8">
						<div class="checkbox icheck">
							<label> <fmt:message key="REMEMBERME" var="rememberme" />
			...
			<a href="${pageContext.request.contextPath}/join.do" class="text-center">${Register}</a>
		</div>
		<!-- /.login-box-body -->
	</div>
	<!-- /.login-box -->
